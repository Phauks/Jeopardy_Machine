...
| ---------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------- |
| `/`                    | **The front door (A1), and the only one** (2026-08-16): rejoin offer, code box + password, create-room form, and the live public-room list, all on one screen. Polls `/api/rooms`; probes `/api/rooms/<CODE>/live` for each remembered room. `/lobby` folded back in here and was DELETED - no redirect (no-legacy directive). Simplified 2026-08-17 to a header + four controls with no explanatory prose; the dev index lives in a header menu, and the list is searchable | none       |
...
| Mirror mode                                   | device | C1b, explicitly per-device: a co-host on a second laptop keeps the full private console                               |
