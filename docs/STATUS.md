...
| Room instrument panel: create/delete rooms, session room list, join roles, DO inspector, lobby watch, refusal probes                     | `pnpm dev:rooms`, open http://localhost:8788/dev/rooms                                                                                           |
