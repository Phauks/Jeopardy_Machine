...
<main class="front-door">
  ...
  <footer class="page-foot">
    <div class="band-inner foot-inner">
      <p class="foot-line">
        You run the board on the big screen; everyone else scans a code and buzzes in from their
        own phone. No app, no account, nothing to install - and nothing kept after the night
        ends.
      </p>
      <dl class="foot-facts">
        <div>
...
<style>
  ...
  /* The quiet end of the page is an ink block too, for a concrete reason as much as a
     stylistic one: the page ground is --board-bg, which is near-black in three presets and
     PAPER in the event-poster one, so text laid straight onto it has no guaranteed partner
     color. Inside a cell-derived block, --clue-text-color is guaranteed to work. */
  .page-foot {
    background: color-mix(in srgb, var(--board-cell-bg) 22%, #000000);
  }
  ...
  .foot-line {
    margin: 0;
    /* A hard measure so the line breaks where the design decided rather than where the window
       happens to end - the one thing worth keeping from the hero this replaces. */
