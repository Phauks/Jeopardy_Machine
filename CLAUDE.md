...
| `tools/event-media-bake/`  | Offline image pipeline for the event picture round (Commons originals -> license + sha1 re-verified, downscaled WebP under `events/board-game-club-x-els/media/`, pack media refs and the game's pack hash rewritten).                                                       |
