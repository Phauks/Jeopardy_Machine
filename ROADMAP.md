...
- [ ] Next for the exit criteria: the event game needs to be reachable from the create form (the pack join exists; choosing which game a room opens with does not), and the picture round needs its media served
